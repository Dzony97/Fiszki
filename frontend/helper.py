...
<SecondLearnScreen>:    
    ...
    BoxLayout:
        ...
        MDTopAppBar:
            id: learn_bar
            title: ''
            right_action_items: [["arrow-left", lambda x: app.change_screen('main')],["plus", lambda x: app.root.get_screen('secondlearn').show_dialog()]]
            pos_hint: {"center_y": 1}
...
<SecondWordWidget>:
    MDRaisedButton:
        ...
        font_size: "20dp"
        theme_text_color: 'Error'
        on_release: root.second_toggle_text()
...
<CustomWidget>:    
    MDFillRoundFlatIconButton:
        ...
        font_size: "20dp" 
        theme_text_color: 'Hint'
        on_release: app.change_screen('secondlearn')
